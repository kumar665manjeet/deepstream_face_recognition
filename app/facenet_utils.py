...
def predict_using_classifier(faces_embeddings, labels, face_to_predict_embedding, threshold=60):
...
def train_classifier(faces_embeddings, labels, classifier_name='knn'):
	...
	save_path = os.path.join(os.getcwd(), 'classifiers','{}.sav'.format(classifier_name))
